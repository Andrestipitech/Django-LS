...
from apps.persona.views import PersonaList, PersonaCreate, PersonaEdit, PersonaDelete
from . import views
app_name = 'persona'
urlpatterns = [
    ...
    #path('<pk>/editp', PersonaEdit.as_view(), name='persona_editar'),
    path('editp/<str:pk>/', PersonaEdit.as_view(), name='persona_editar'),
